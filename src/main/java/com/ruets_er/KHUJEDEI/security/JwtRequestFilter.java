/*
 * Copyright (c) 2022.
 * Document   : JwtRequestFilter.java
...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
        ...
        if(URL.equals("/api/posts") || URL.equals("/api/postDetails") ||URL.equals("/") || URL.equals("/api/images") || URL.equals("/callback") || URL.equals("/callback/testMsg") || URL.equals("/authenticate") || URL.equals("/api/checkUserNameAvailablity") || URL.equals("/api/registerUser"))
        {
